...
## Inputs
Optional: existing skills to disambiguate triggers against; a reference SKILL.md to match style.
...
- Bridge the gap from "thinking about a skill" to "having a skill".
